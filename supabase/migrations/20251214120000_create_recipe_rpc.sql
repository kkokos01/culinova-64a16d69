-- Create the missing RPC function for recipe creation with ingredients
-- This function handles both recipe creation and ingredient/steps insertion in one transaction
